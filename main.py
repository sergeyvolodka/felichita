...
def main(message):
    ...
    if message.text == '🦷Филиал Бетанкура 29':
        bot.send_message(message.chat.id,
                         text='*Друзья, мы рады сообщить Вам прекрасную новость!\n В стоматологической клинике "Феличита" '
                              'открылся центр имплантологии по адресу: ул. Бетанкура, д.29, П7\n'
                              'https://taplink.cc/felichita_nn*',
